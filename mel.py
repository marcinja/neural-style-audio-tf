...
content_spec, fs = read_audio_spectum(CONTENT_FILENAME)
style_spec, fs = read_audio_spectum(STYLE_FILENAME)

mel_content = mel_spec(content_spec)
mel_style = mel_spec(style_spec)
